...
RSpec.describe "Preferences", type: :feature do
  ...
  describe "Edge cases" do
    xit "Prefills the 'Start Page' and 'Default Visibility' fields with the user's saved values" do
      # Fields land in Block 3 — this page is scaffolding-only in Block 1.
    end
  end
end
